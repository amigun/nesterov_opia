...
public class Vector : ICloneable
{
    ...
    protected static int CountOfVectors { get; set; } = 0;

    protected static int CountOfZeroVectors { get; set; } = 0;

    protected static int CountOfVectorsThatLessThan10 { get; set; } = 0;
